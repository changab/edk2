...
{
  UINT64  DebugProp = FixedPcdGet64 (PcdRedfishPlatformConfigDebugProperty);
...
RedfishPlatformConfigFeatureProp (
  IN UINT16  FeatureType
  )
{
  UINT64  FeatureProp = FixedPcdGet64 (PcdRedfishPlatformConfigFeatureProperty);
