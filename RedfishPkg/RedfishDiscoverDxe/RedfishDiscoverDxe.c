...
Tcp4GetSubnetInfo (
  ...
  IN EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *Instance
);
...
static REDFISH_DISCOVER_REQUIRED_PROTOCOL RequiredProtocol [] = {
  {
    ProtocolTypeTcp4,
  ...
  )
{
  ...
  Status = RestExLibCreateChild (
            Instance->Owner,
            FixedPcdGetBool (PcdRedfishDiscoverAccessModeInBand)? EFI_REST_EX_SERVICE_IN_BAND_ACCESS: EFI_REST_EX_SERVICE_OUT_OF_BAND_ACCESS,
...
/**
  This function get EFI_REDFISH_DISCOVERED_INTERNAL_INSTANCE
  by known owner handle.
...
GetInstanceByOwner (
  IN EFI_HANDLE ImageHandle,
  IN EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *TargetNetworkInterface,
...
/**
  This function searches EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL
  instance with the given  EFI_REDFISH_DISCOVER_NETWORK_INSTANCE.

  @param[in] TargetNetworkInterface  EFI_REDFISH_DISCOVER_NETWORK_INSTANCE.
                        NULL for all EFI_REDFISH_DISCOVER_NETWORK_INSTANCEs.

  @retval Non-NULL  EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL is returned.
  @retval NULL      Non of EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL instance is returned.
**/
EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *
GetTargetNetworkInterfaceInternal (
  IN EFI_REDFISH_DISCOVER_NETWORK_INSTANCE  *TargetNetworkInterface
  )
{
  EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *ThisNetworkInterface;

  ThisNetworkInterface = (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *)GetFirstNode (&mEfiRedfishDiscoverNetworkInterface);
  while (TRUE) {
    ...
    ThisNetworkInterface = (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *)GetNextNode(&mEfiRedfishDiscoverNetworkInterface, &ThisNetworkInterface->Entry);
  };
  return NULL;
}
  ...
  )
{
  ...
  if (Flags & EFI_REDFISH_DISCOVER_SSDP) {
...
/**
  ...
  @param[in]    ThisNetworkInterface   EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL
...
BOOLEAN
CheckIsIpVersion6 (
  IN EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *ThisNetworkInterface
)
{
...
{
  EFI_STATUS Status;
  REDFISH_OVER_IP_PROTOCOL_DATA *Data = NULL;
  REDFISH_INTERFACE_DATA  *DeviceDescriptor = NULL;
  ...
  EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *NetworkInterface;
  BOOLEAN IsHttps;
...
/**
  ...
  @param[in]    Instance     EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL instance.
  ...
  )
{
  ...
  EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *NewNetworkInterface;
  ...
  if (RequiredProtocol [ProtocolType].GetSubnetInfo != NULL && Instance->GotSubnetInfo == FALSE) {
    Status = RequiredProtocol [ProtocolType].GetSubnetInfo (
        ImageHandle,
        Instance
        );
    if (EFI_ERROR (Status)) {
      ...
      if (CheckIsIpVersion6 (Instance) == TRUE) {
        ...
        for (IPv6InfoIndex = 0; IPv6InfoIndex < Instance->SubnetAddrInfoIPv6Number - 1; IPv6InfoIndex++) {
          //
          // Build up addtional EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL instances.
          //
          NewNetworkInterface = (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *)AllocateZeroPool (sizeof (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL));
          if (NewNetworkInterface != NULL) {
            CopyMem ((VOID *)NewNetworkInterface, (VOID *)Instance, sizeof (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL)); // Clone information of first instance.
...
RedfishServiceGetNetworkInterface (
  ...
  OUT EFI_REDFISH_DISCOVER_NETWORK_INSTANCE **NetworkIntfInstances
)
{
  EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *ThisNetworkInterfaceIntn;
  ...
  *NetworkIntfInstances = NULL;
  ...
  ThisNetworkInterface = (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE *)AllocateZeroPool (sizeof (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE) * mNumNetworkInterface);
  if (ThisNetworkInterface == NULL) {
    return EFI_OUT_OF_RESOURCES;
  }
  *NetworkIntfInstances = ThisNetworkInterface;
  ThisNetworkInterfaceIntn = (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *)GetFirstNode (&mEfiRedfishDiscoverNetworkInterface);
  while (TRUE) {
    ...
    ThisNetworkInterfaceIntn = (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *)GetNextNode(&mEfiRedfishDiscoverNetworkInterface, &ThisNetworkInterfaceIntn->Entry);
  ...
  )
{
  ...
  EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *TargetNetworkInterfaceInternal;
  ...
  if (TargetNetworkInterface != NULL) {
    ...
    TargetNetworkInterfaceInternal = (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *)GetFirstNode (&mEfiRedfishDiscoverNetworkInterface);
  ...
  for (NetworkInterfacesIndex = 0; NetworkInterfacesIndex < NumNetworkInterfaces; NetworkInterfacesIndex ++) {
    ...
    if (Flags & EFI_REDFISH_DISCOVER_HOST_INTERFACE) {
    ...
    if (TargetNetworkInterface == NULL) {
      ...
      //
      TargetNetworkInterfaceInternal = (EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *)GetNextNode(&mEfiRedfishDiscoverNetworkInterface, &TargetNetworkInterfaceInternal->Entry);
    }
  }
  return EFI_SUCCESS;
}
...
/**
  This function create an EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL for the
  given network interface.


  @param[in]  MacAddress          MAC address of this network interface.
  @param[in]  NetworkProtocolType Network protocol type.
  @param[out] IsNewInstane        BOOLEAN means new instance or not.
  @param[out] NetworkInterface    Pointer to to EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL.
...
CreateRedfishDiscoverNetworkInterface (
  ...
  OUT EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL **NetworkInterface
  )
{
...
/**
  ...
  @param[in]  ThisNetworkInterface EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL instance.
  ...
  )
{
  ...
  Status = gBS->UninstallProtocolInterface(
                  ...
                  RequiredProtocol [ThisNetworkInterface->NetworkProtocolType].DiscoveredProtocolGuid,
  ...
  )
{
  ...
  for (Index = 0; Index < (sizeof (RequiredProtocol) / sizeof (REDFISH_DISCOVER_REQUIRED_PROTOCOL)); Index ++) {
    Status = gBS->OpenProtocol (
                  ControllerHandle,
                  RequiredProtocol [Index].RequiredServiceBindingProtocolGuid,
                  NULL,
    ...
    if (!EFI_ERROR (Status)) {
      Status = gBS->OpenProtocol (
                      ControllerHandle,
                      RequiredProtocol [Index].DiscoveredProtocolGuid,
                      (VOID **) &Id,
                      This->DriverBindingHandle,
                      ControllerHandle,
  ...
  )
{
  ...
  do {
    ...
    if (!EFI_ERROR (Status)) {
      Index ++;
      if (Index == (sizeof(RequiredProtocol) / sizeof(REDFISH_DISCOVER_REQUIRED_PROTOCOL))) {
        break;
      }
      continue;
    }
    ...
    if (RequiredProtocol [Index].ProtocolType != ProtocolTypeRestEx) {
      OldTpl = gBS->RaiseTPL (EFI_REDFISH_DISCOVER_NETWORK_INTERFACE_TPL);
      Status = CreateRedfishDiscoverNetworkInterface(ControllerHandle, RequiredProtocol [Index].ProtocolType, &IsNew, &NetworkInterface);
      if (EFI_ERROR (Status)) {
        gBS->RestoreTPL (OldTpl);
        return Status;
      }
      NetworkInterface->NetworkProtocolType = RequiredProtocol [Index].ProtocolType;
      ...
      NetworkInterface->NetworkInterfaceProtocolInfo.ProtocolGuid = \
        *RequiredProtocol [Index].RequiredProtocolGuid;
      ...
      // Redfish Service Discover protocol will match REST EX to the corresponding EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL
      // when discovery.
      ...
      Interface = &RestExInstance->RestExProtocolInterface;
    }
    ...
    if (!EFI_ERROR (Status)) {
      ...
      if (!EFI_ERROR (Status)) {
        if (EfiRedfishDiscoverProtocolHandle == NULL &&
            (RequiredProtocol [Index].ProtocolType == ProtocolTypeRestEx) &&
  ...
  } while (Index < (sizeof(RequiredProtocol) / sizeof(REDFISH_DISCOVER_REQUIRED_PROTOCOL)));
  return EFI_UNSUPPORTED;
}
/**
  ...
  @param[in]  ControllerHandle        The handle of the controller to test. This handle
                                      must support a protocol interface that supplies
                                      an I/O abstraction to the driver.
  @param[in]  RequiredProtocol       Pointer to the instance of REDFISH_DISCOVER_REQUIRED_PROTOCOL.
