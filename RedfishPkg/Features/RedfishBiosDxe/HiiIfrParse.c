/** @file
  Internal Functions for parsing HII IFR binary.
...
/**
  ...
  @param  UnicodeString           The Unicode string retrieved.
  ...
  )
{
  ...
  switch (StorageType) {
    case EFI_HII_VARSTORE_BUFFER:
      ...
      Storage->Name    = AllocateZeroPool (sizeof (CHAR16) * (AsciiStrLen (AsciiStorageName) + 1));
