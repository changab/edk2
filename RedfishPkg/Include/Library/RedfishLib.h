...
typedef struct {
  CONST CHAR8 *PropertyName; ///< Name of Attribute Registry property.
  CHAR8 *PropertyStr;        ///< String pointer of property value.
} REDFISH_DEFAULT_ATTRIBUTE_REGISTRY_PROPERTY;
///
...
/**
  ...
  @param[in]  ServiceVersionStr   Redfish service string.
