...
#define BOOT_IN_RECOVERY_MODE                         0x20
  ...
  gEmulatorPkgTokenSpaceGuid.PcdEmuNetworkInterface|L"1"  # office
  gEmulatorPkgTokenSpaceGuid.PcdEmuNetworkInterface|L"8"  # home
...
!if $(REDFISH_ENABLE) == TRUE
  ...
  #
  gEfiRedfishPkgTokenSpaceGuid.PcdRedfishRestExServiceDevicePath.DevicePath|{DEVICE_PATH("MAC(6c2408025914,0x1)")}
