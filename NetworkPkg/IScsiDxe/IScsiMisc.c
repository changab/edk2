...
)
{
  ...
  for (Index = 1; Index <= KeywordNum; Index ++) {
    ...
    HiiCreateStringOpCode (
      ...
      StringToken,
      STRING_TOKEN (STR_ISCSI_ATTEMPTT_NAME_HELP),
      EFI_IFR_FLAG_READ_ONLY | EFI_IFR_FLAG_REST_STYLE,
      0,
      0,
      ATTEMPT_NAME_SIZE,
      NULL
    ...
    HiiCreateNumericOpCode (
      ...
      StringToken,
      STRING_TOKEN (STR_ISCSI_MODE_HELP),
    ...
    HiiCreateNumericOpCode (
      ...
      StringToken,
      STRING_TOKEN (STR_ISCSI_IP_MODE_HELP),
      EFI_IFR_FLAG_REST_STYLE,
      EFI_IFR_NUMERIC_SIZE_1,
      0,
      2,
    ...
    HiiCreateNumericOpCode (
      ...
      StringToken,
      STRING_TOKEN (STR_ISCSI_CONNECT_RETRY_HELP),
      EFI_IFR_FLAG_REST_STYLE,
      EFI_IFR_NUMERIC_SIZE_1,
      0,
      16,
    ...
    HiiCreateNumericOpCode (
      ...
      StringToken,
      STRING_TOKEN (STR_ISCSI_CONNECT_TIMEOUT_HELP),
      EFI_IFR_FLAG_REST_STYLE,
