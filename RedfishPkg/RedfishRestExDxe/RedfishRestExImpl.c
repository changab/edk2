...
)
{
  ...
  case RestExSendChunkHeaderZeroContent:
      ...
      //MessageBodyLength = AsciiStrLen ("0") + 2 + 2 + 1;
      //MessageBody = AllocateZeroPool(MessageBodyLength);
      //AsciiSPrint(MessageBody, MessageBodyLength, "%x%c%c%c%c", 0, CHUNKED_TRNASFER_CODING_CR, CHUNKED_TRNASFER_CODING_LF, CHUNKED_TRNASFER_CODING_CR, CHUNKED_TRNASFER_CODING_LF);
      MessageBodyLength = 0;
      MessageBody = NULL;
