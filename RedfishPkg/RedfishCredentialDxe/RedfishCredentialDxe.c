/** @file
  RedfishCrentialDxe produces the RedfishCredentialProtocol for the consumer
...
{
  LibCredentialExitBootServicesNotify ((EFI_REDFISH_CREDENTIAL_PROTOCOL *)Context);
}
...
{
  LibCredentialEndOfDxeNotify ((EFI_REDFISH_CREDENTIAL_PROTOCOL *)Context);
