...
typedef struct {
  ...
  EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL *NetworkInterface; ///< EFI_REDFISH_DISCOVER_NETWORK_INSTANCE_INTERNAL
...
/**
  ...
  @param[in]  DeviceDescriptor Pointer to REDFISH_INTERFACE_DATA.
  @param[in]  ProtocolData     Pointer to REDFISH_OVER_IP_PROTOCOL_DATA.
